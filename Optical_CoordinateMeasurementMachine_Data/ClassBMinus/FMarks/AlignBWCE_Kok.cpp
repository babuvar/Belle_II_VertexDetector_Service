...
//cout<<(x-115.76)*1000<<"μm\t"<<(y-0.15)*1000<<"μm\t"<<(z-(13.02))*1000<<"μm"<<endl;//BW sensor
cout<<(x-240.76)*1000<<"μm\t"<<(y-0.15)*1000<<"μm\t"<<(z-(13.02))*1000<<"μm"<<endl;//CE sensor
...
U1[0].set(62.05+0.1,-29.25-0.1,0);
U1[1].set(62.05-0.1,-29.25-0.1,0);
U1[2].set(62.05-0.1,-29.25+0.1,0);
U1[3].set(62.05+0.1,-29.25+0.1,0);

U1[4].set(-62.05+0.1,-29.25-0.1,0);
U1[5].set(-62.05-0.1,-29.25-0.1,0);
U1[6].set(-62.05-0.1,-29.25+0.1,0);
U1[7].set(-62.05+0.1,-29.25+0.1,0);
...
U1[12].set(62.05+0.1,29.55-0.1,0);
U1[13].set(62.05-0.1,29.55-0.1,0);
U1[14].set(62.05-0.1,29.55+0.1,0);
U1[15].set(62.05+0.1,29.55+0.1,0);
...
//float parA=-0.00100943,parB=0.0000002;//Values got from fitting Random pts on surface   CE
float parA=0.000183923,parB=0.00142959;//Values got from fitting Random pts on surface   BW
