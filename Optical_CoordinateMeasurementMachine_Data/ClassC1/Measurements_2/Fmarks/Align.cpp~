...
//Aligning w.r.t.  reference
A.set(425.324,222.551); A1.set(425.324,222.551,59.334);//A1.print();
B.set(571.322,221.475);
C=B.sub(A);
UnitX=C.GetUnit();
...
float parA=0.00402012,parB=-0.211847;//Values got from fitting Random pts on surface
