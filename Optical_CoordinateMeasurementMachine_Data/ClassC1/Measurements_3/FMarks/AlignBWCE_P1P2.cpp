...
//cout<<(x+73)*1000<<"μm\t"<<(y-(103))*1000<<"μm\t"<<(z-(13.02))*1000<<"μm"<<endl;//CE sensor after asswmbly
...
//float parA=-0.000998078,parB=-0.00081316;//Values got from fitting Random pts on surface    CE
float parA=-0.000476194,parB=-0.000251516;//Values got from fitting Random pts on surface    BW
