...
A.set(408.275,206.991); A1.set(408.275,206.991,106.279);//A1.print();
B.set(554.271,208.549); B1.set(554.271,208.549,106.279);
C=B.sub(A);
UnitX=C.GetUnit();
...
float parA=-0.00461985,parB=-0.211507;//Values got from fitting Random pts on surface
