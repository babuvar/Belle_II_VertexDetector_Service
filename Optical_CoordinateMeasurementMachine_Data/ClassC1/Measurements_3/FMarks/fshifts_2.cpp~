...
B.set(554.271,208.549);B1.set(554.271,208.549,106.279167875);//z is set from bw mount block measurement
A.set(408.275,206.991);A1.set(408.275,206.991,106.279167875);//z is set from bw mount block measurement
C=B.sub(A);
UnitX=C.GetUnit();
