...
vec3 UnitX1,UnitY1;
B.set(554.271,208.549);B1.set(554.271,208.549,59.402);
A.set(408.275,206.991);A1.set(408.275,206.991,59.402);
C=B.sub(A);
UnitX=C.GetUnit();
...
vec3 K(482.906,70.021,106.279167875);// Origin Point, taken as BW Kokeshi Pin center
