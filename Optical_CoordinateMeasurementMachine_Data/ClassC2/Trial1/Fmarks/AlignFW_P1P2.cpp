...
A.set(408.899,221.008); A1.set(408.899,221.008,106.279);//A1.print();
B.set(554.906,221.184); B1.set(554.906,221.184,106.279);
C=B.sub(A);
UnitX=C.GetUnit();
...
//CM.print();
CM1=CM.sub(B1); CM2.set(CM1.X,CM1.Y);
x =CM2.dot(UnitX);
y =CM2.dot(UnitY);
z=CM1.Z;
CM.set(x,y,z);
cout<<"Center of gravity w.r.t Ref Pt origin"<<endl;

cout<<(x+73)*1000<<"μm\t"<<(y-(227.3135))*1000<<"μm\t"<<(z+(0.1045))*1000<<"μm"<<endl;//FW sensor after asswmbly


//cout<<(x-73)*1000<<"μm\t"<<(y-(230.6345))*1000<<"μm"<<endl;//FW sensor before assembly
//cout<<(x-73)*1000<<"μm\t"<<(y-(227.313))*1000<<"μm"<<endl;//FW sensor after asswmbly

//CM.print();


//Rotation in th x-y plane
U[0].set(20.369+0.075,61.290-0.075);
U[1].set(20.369+0.075,61.290+0.075);
U[2].set(20.369-0.075,61.290+0.075);
U[3].set(20.369-0.075,61.290-0.075);
U[4].set(30.156+0.075,-61.290-0.075);
U[5].set(30.156+0.075,-61.290+0.075);
U[6].set(30.156-0.075,-61.290+0.075);
U[7].set(30.156-0.075,-61.290-0.075);
U[8].set(-30.156+0.075,-61.290-0.075);
U[9].set(-30.156+0.075,-61.290+0.075);
U[10].set(-30.156-0.075,-61.290+0.075);
U[11].set(-30.156-0.075,-61.290-0.075);
U[12].set(-20.369+0.075,61.290-0.075);
U[13].set(-20.369+0.075,61.290+0.075);
U[14].set(-20.369-0.075,61.290+0.075);
U[15].set(-20.369-0.075,61.290-0.075);
...
U1[0].set(20.369+0.075,62.637-0.075,0);
U1[1].set(20.369+0.075,62.637+0.075,0);
U1[2].set(20.369-0.075,62.637+0.075,0);
U1[3].set(20.369-0.075,62.637-0.075,0);
U1[4].set(30.156+0.075,-62.637-0.075,0);
U1[5].set(30.156+0.075,-62.637+0.075,0);
U1[6].set(30.156-0.075,-62.637+0.075,0);
U1[7].set(30.156-0.075,-62.637-0.075,0);
U1[8].set(-30.156+0.075,-62.637-0.075,0);
U1[9].set(-30.156+0.075,-62.637+0.075,0);
U1[10].set(-30.156-0.075,-62.637+0.075,0);
U1[11].set(-30.156-0.075,-62.637-0.075,0);
U1[12].set(-20.369+0.075,62.637-0.075,0);
U1[13].set(-20.369+0.075,62.637+0.075,0);
U1[14].set(-20.369-0.075,62.637+0.075,0);
U1[15].set(-20.369-0.075,62.637-0.075,0);
...
float parA=-0.000439753,parB=-0.211039;//Values got from fitting Random pts on surface
