...
vec3 UnitX1,UnitY1;
B.set(554.906,221.184);B1.set(554.906,221.184,106.279);//P2
A.set(408.899,221.008);A1.set(408.899,221.008,106.279);//P1
C=B.sub(A);
UnitX=C.GetUnit();
UnitY=UnitX.Rotate(pi/2);
...
vec3 K(482.242,83.368,106.279167875);// Origin Point, taken as BW Kokeshi Pin center
...
L1p.set(20.519,426.365,-13.021);
L2p.set(30.307,303.781,12.812);
L3p.set(-30.007,303.781,12.812);
L4p.set(-20.219,426.365,-13.021);
...
N1p.set(29.550,177.810,13.020);
N2p.set(29.550,53.710,13.020);
N3p.set(-29.250,53.710,13.020);
N4p.set(-29.250,177.810,13.020);
